...
page_setup("Observatorio de Fiscalizacion")
data = load_all()
casos = data["casos"]
sanciones = data["sanciones"]
agravios = data["agravios"]

st.title("Observatorio de Fiscalizacion y Justicia Electoral 2023-2024")
st.caption("Corte operativo federal para reconstruir acto de origen, impugnacion, agravios, sentido, efectos y diputaciones electas.")
mvp_notice()
