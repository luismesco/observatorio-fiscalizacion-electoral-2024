...
.toc-title {{ color: #14100d; font-size: 49px; font-weight: 900; line-height: .9; text-transform: uppercase; margin-top: 22px; }}
...
.meeting-grid {{ display: grid; grid-template-columns: repeat(3, 1fr); gap: 18px; margin-top: 24px; }}
.meeting-card {{ border-top: 5px solid #C59A3D; padding-top: 10px; min-height: 148px; }}
.meeting-card strong {{ display: block; color: #3b0718; font-size: 13px; line-height: 1.12; text-transform: uppercase; }}
.meeting-card p {{ margin-top: 8px; font-size: 9.9px; line-height: 1.34; }}
.flow-grid {{ display: grid; grid-template-columns: repeat(5, 1fr); gap: 10px; margin-top: 26px; }}
.flow-grid span {{ border: 1px solid #d7c7b2; border-top: 4px solid #6B1531; padding: 10px 9px; color: #3b0718; font-size: 9.4px; font-weight: 900; text-transform: uppercase; text-align: center; min-height: 46px; }}
...
<body>
    ...
    <div class="cover-layout">
      ...
      <div>
        <div class="cover-meta">
          <strong>Corte documental de fiscalización</strong>
  ...
  <section class="page">
    ...
    <div class="toc-layout">
      ...
      <div class="toc-list">
        <div class="toc-item"><b>01</b><div><strong>Qué se sancionó</strong><span>Causas por monto observado, contexto legislativo y lectura de la sumatoria.</span></div><div class="toc-page">{summary_page_number}</div></div>
