...
def build_diputaciones_report_html() -> str:
  ...
  <section class="page">
    ...
    {amount_note}
    <div class="footer"><span>{REPORT_FOOTER}</span><span>Página {page_number} de {len(case_row_pages) + 3}</span></div>
  </section>
            """
        )
    total_pages = len(case_row_pages) + 4
    model_page_number = total_pages - 1
  ...
  <section class="page">
    ...
    <div class="hero-grid">
      <div>
        ...
        <h1>Qué se sancionó en diputaciones federales 2024</h1>
      </div>
